...
# Input - phylu name; main path that leads to the folder containing the subfolders (i.e. the query proteins) holding the douladed balst output files; finally a list of names of the query proteins(in this case it would be a c("ParA", "ParC", "McdA", "FlhG", "MinD"))
